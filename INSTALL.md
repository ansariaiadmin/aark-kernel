# راهنمای کامل AARK Kernel — Trading Platform — برای افراد غیر فنی

**نسخه:** v1.0.4 — نصب خودکار + آپدیت خودکار
...
- **تکنولوژی:** FastAPI + React
- **آدرس پیش‌فرض:** http://localhost:3000 (Frontend) و http://localhost:8000/docs (API)
- **نوع:** web
...
- سلامت: http://localhost:8000/api/v1/health/ready
...
### ۱. داشبورد اصلی
- آدرس: http://localhost:3000 (Frontend) و http://localhost:8000/docs (API)
...
- **v1.0.3 (Strict Final 10/10 True):** نسخه غیرفنی + نصب خودکار + آپدیت خودکار (همین نسخه)
...
- ایشو باز کن: https://github.com/ansariaiadmin/aark-kernel/issues

**برای افراد کاملا غیر فنی:** فقط `install.sh` را اجرا کن، بعد مرورگر را باز کن به http://localhost:3000 (Frontend) و http://localhost:8000/docs (API) — همین!
