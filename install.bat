...
echo.
echo ========================================
echo   aark-kernel — Setup Wizard v3.1.0 — پشتیبانی صفر — تاریکی روشن شد — Windows
echo ========================================
echo.
echo سلام! 👋 جادوگر aark-kernel — v3.1.0 — تاریکی روشن شد
echo.
...
:create_env
(
echo # aark-kernel — .env — v3.1.0 — تاریکی روشن شد — %date% %time%
...
echo.
echo 🎉 جادو تمام! aark-kernel آماده — تاریکی روشن شد! 🎉
